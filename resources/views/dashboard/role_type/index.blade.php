    ...
    <div  id="alert">
        ...
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.role_type.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.role_type.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.role_type.addEditModal')
      <!-- end add user modal -->
