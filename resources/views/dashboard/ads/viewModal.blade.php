...
<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalScrollableTitle"> تفاصيل</h5>
    ...
    <div class="modal-body">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
           ميعاد بداية ظهور الاعلان  
          <span class="start_date">2</span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
           ميعاد نهاية ظهور الاعلان  
          <span class="end_date">2</span>
        </li>
      </ul>
    </div>
