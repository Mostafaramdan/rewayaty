...
use App\Models\effects as model;
...
class effects extends Controller
{
    ...
    public static function index()
    {
        ...
        return view('dashboard.effects.index',compact("records","totalPages",'currentPage'));
    }   
    ...
    public static function indexPageing(Request $request)
    {
      ...
      $records= self::$model::all()->$sort($request->sortBy??"id",);    if($request->search){
        ...
        $tableInfo= (string) view('dashboard.effects.tableInfo',compact('records'));
    ...
    public static function createUpdate(Request $request)
    {
        ...
        $messagesAr=[
            ...
            "effectFile.required_if"     =>"يجب ادخال ملف الخط",
